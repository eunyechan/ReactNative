...
export default class Main extends Component{
    render(){
        ...
        return(
            ...
            // <View style={style.container}>
            //     <Text style={style.title}>List</Text>
            ...
            //4. 함수(메소드)를 호출할 때 매개변수 전달하여 사용하기
            // <View style={style.container}>
            //     <Text style={style.title}>List</Text>

            //     {/* 멤버메소드 호출 */}
            //     {this.showItemView2('sam', 'first', 'indigo')}
            //     {this.showItemView2('sam2', 'second', 'red')}
            ...
            <View style={style.container}>
                <Text style={style.title}>List Layout</Text>
