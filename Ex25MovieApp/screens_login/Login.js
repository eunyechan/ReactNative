...
export default class Login extends Component{
        ...
        return(
            <View style={styles.root}>
                ...
                <View style={styles.footer}>
                    <Text style={styles.footerCopyright}>MovieApp by eunyechan</Text>
                </View>
    ...
    login= async()=>{
        //AsyncStorage에 영구 저장
        await AsyncStorage.setItem('email', 'android@eunyechan.com');

        //로그인이 되었으니 메인화면인 MovieList를 가진 drawerNav로 이동
        this.props.navigate.replace('MainDrawerNav');
    }
