        ...
        return(
            <View style={styles.root}>
                ...
                <View style={styles.content}>
                    ...
                    {/* 전화번호 탭일때 안내메세지 */}
                    {
                        this.state.tabIndex===0 && <Text style={styles.telMessage}>Movie App의 업데이트 내요을 SMS로 수신할 수 있으며, 언제든지 수신을 취소할 수 있습니다.</Text>
                    }
                ...
                <View style={styles.footer}>
                    <Text style={styles.footerMsg}>
                        이미 계정이 있으신가요?<Text onPress={()=>this.props.navigation.goBack()} style={styles.goback}>로그인하기</Text>
                    </Text>
                </View>
            </View>
        );
