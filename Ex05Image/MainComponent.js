...
export default class MainComponent extends Component{
    ...
    render(){
        return(
            ...
            // //주의!! 네트워크 이미지는 반드시 width, height을 명시적으로 주어야함[둘다모두]. 안주면 화면에 표시 x
            // <View style={ {flex:1} }>
            //     <Image 
            ...
            //         <Image style={{width:200, height:250, resizeMode:'cover'}}
            //         source={require('./images/moana03.jpg')}>
            //         </Image>
            //         {/* 이미지의 가로 사이즈를 화면에 맞추려면 스타일로 width:null, resizeMode:'contain'속성으로 지정해야함 */}
            ...
            //4.3 안드로이드의 버튼을 클릭했을 때 효과: TouchableNativeFeedback [only android]
