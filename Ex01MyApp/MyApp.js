...
class MyApp extends Component{
    ...
    //한 번에 하나에 Component만 리턴할 수 있음
    //여러개를 보여주고 싶다면 ViewGroup역할이 필요함(Layout같은..웹의 div같은)
    render(){
        ...
        return (
            <View style={styles.root}>
                ...
                <Text style={plainTextStyle}>Nice</Text>
...
const rootView={
    ...
    //height: '100%'
    //RN은 기본적으로 css중 flex스타일 적용되어 있음
    //이미 display:flex는 되어 있는 상태
    flex:1, //layout_weight과 같은 역할
    padding: 16,
};
