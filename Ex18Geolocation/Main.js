        ...
        return(
            <View style={styles.root}>
                ...
                <View style={{flexDirection:'row', justifyContent:'space-between', marginTop:16}}>
                    <Button onPress={this.clickBtn2} color='green' title='wacth my location: update'></Button>
                    <Button onPress={this.clickBtn3} color='blue' title='stop my location'></Button>
                </View>
